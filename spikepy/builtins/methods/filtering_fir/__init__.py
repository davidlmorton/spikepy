...
from .run import run as fir_run
...
class FilteringFIR(FilteringMethod):
    ...
    '''
    def __init__(self):
        self.name = 'Finite Inpulse Response'
    ...
    def run(signal_list, sampling_freq, **kwargs):
        return fir_run(signal_list, sampling_freq, **kwargs)
